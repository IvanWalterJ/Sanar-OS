    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div>
        <div className="flex items-center gap-2 mb-2">
          <span className="text-[9px] uppercase font-bold px-2 py-0.5 rounded-full bg-[#F5F0E1]/10 text-[#F5F0E1]/70 border border-[#F5F0E1]/15 tracking-wider">
            COACH
          </span>
          {checked && (
      ...
      {meta.coach_instruccion && (
        <div className="card-panel p-5 border border-[#D4A24E]/15 bg-[#D4A24E]/[0.03]">
          ...
          <p className="text-sm text-[#F5F0E1]/80 leading-relaxed whitespace-pre-wrap">
            {meta.coach_instruccion}
          </p>
        </div>
      )}
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-4 rounded-xl bg-[#D4A24E]/10 border border-[#D4A24E]/20 text-[#D4A24E] font-medium hover:bg-[#D4A24E]/15 transition-colors"
      >
      ...
      <div className="border-t border-[rgba(212,162,78,0.1)] pt-5">
        {checked ? (
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            <input
              ...
              className="w-5 h-5 rounded border-[rgba(212,162,78,0.3)] bg-transparent accent-[#2DD4A0] cursor-pointer"
            />
            <span className="text-sm text-[#F5F0E1]/70 group-hover:text-[#F5F0E1] transition-colors">
