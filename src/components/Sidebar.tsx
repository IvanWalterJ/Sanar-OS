...
import { LayoutDashboard, Map, MessageSquare, TrendingUp, Users, Settings, LogOut, Hexagon, BookOpen, Library } from 'lucide-react';
  ...
  return (
    <aside className="w-20 lg:w-64 h-full glass-panel flex flex-col items-center lg:items-start py-6 transition-all duration-300 z-20">
      <div className="flex items-center justify-center lg:justify-start w-full px-0 lg:px-6 mb-10">
        ...
        <span className="hidden lg:block ml-3 font-bold text-base tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-white to-white/60">
          Tu Clínica Digital
        </span>
      </div>
